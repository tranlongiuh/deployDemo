...
public class PaymentServiceImpl implements PaymentService {
     ...
     */
    @Override
    public Boolean purchase(String username, Long orderId, String confirmPassword) {
                ...
                if (orders != null) {
                    if (orders.getTotalPrice()
                        ...
                        if (payment.getPaymentMethod()
                            ...
                            // cap nhat trang thai thanh toan TODO: ap ma giam gia
    ...
    private List<OrderItem> getOrderItems(Orders orders) {
        ...
        orderItems.forEach(orderItem -> {
            User manager = userService.findById(orderItem.getStall()
                                                         .getManagerId());
            manager.setBalance(manager.getBalance()
